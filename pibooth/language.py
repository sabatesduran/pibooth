...
DEFAULT = {
    ...
    'ca': {
        ...
        'chosen': "Endevant!!",
        'smile': "Somriu!!",
        'processing': "Treient cares llargues...",
        'print': "Imprimir?",
        'print_forget': "Oblidar?",
        'finished': "Fet! La tindras al canal de Telegram en uns segons",
        'oops': "Casum seuna! Algun error hem tingut per aquí",
    },
    'fr': {
